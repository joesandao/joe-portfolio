                ...
                <div className="flex flex-col md:flex-row gap-y-6">
                  ...
                  <div className="flex-1 md:pl-8 relative pb-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="prose prose-invert max-w-none prose-headings:scroll-mt-8 prose-headings:font-semibold prose-a:no-underline prose-headings:tracking-tight prose-headings:text-balance prose-p:tracking-tight prose-p:text-balance">
                        <MDX />
                      </div>
                    </div>
                  </div>
